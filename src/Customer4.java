...
public class Customer4 {
    public static void main(String[] args) {
        Customer c1 = new Customer("Da", "Normal");
        Customer c2 = new Customer("Mey", "Premium");
        Customer c3 = new Customer("David", "Gold");
        Customer c4 = new Customer("Koko", "Silver");

        Sale sale_c1 = new Sale(c1, "2024-02-10");
        Sale sale_c2 = new Sale(c2, "2024-02-11");
        Sale sale_c3 = new Sale(c3, "2024-02-12");
        Sale sale_c4 = new Sale(c4, "2024-02-13");
